      ...
      <section className="advantages">
        <div className="container">
          ...
          <p>
            ...
            сертифіковані тренери, які живуть спортом. Індивідуаьний підхід до
            кожного атлета забезпечує відповідний результат. У нас займаються як
            новачки, які ніколи не тримали гирі в руках, так і професійні
            спортсмени та тренери для підтримання власної форми і знань.
            Особлива увага приділяється тим, хто прийшов вперше на заняття з
            crossfit щоб розвіяти міф, що такий спорт тільки для дужих
            спортсменів. Ми гуртуємо спільноту, нас об'єднало прагнення до
            розвитку яке переросло у щось більше ніж тренування, постійні виїзди
            на змагання, спільний відпочинок, поїздки до нових місць та
            підтримка одне одного - ми стали чимось більшим ніж просто зал!
          </p>
